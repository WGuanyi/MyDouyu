...
#warning 修改的地方
        // 状态
        self.stateLabel.mj_x = self.mj_w / 2 - ImageAndLabelOfSet + 5;
        self.stateLabel.mj_y = self.mj_h * 0.5 * 0.3;
        self.stateLabel.mj_w = self.mj_w / 2;
        self.stateLabel.mj_h = self.mj_h * 0.5 * 0.7;
        
        // 更新时间
        self.lastUpdatedTimeLabel.mj_x = self.mj_w / 2 - ImageAndLabelOfSet + 5;
        self.lastUpdatedTimeLabel.mj_y = self.mj_h * 0.5;
        self.lastUpdatedTimeLabel.mj_w = self.mj_w / 2;
        self.lastUpdatedTimeLabel.mj_h = self.stateLabel.mj_h;
    }
}
