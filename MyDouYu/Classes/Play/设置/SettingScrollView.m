...
@implementation SettingScrollView
...
+ (instancetype)settingScrollView {
    return [[[NSBundle mainBundle] loadNibNamed:@"SettingScrollView" owner:nil options:nil] firstObject];
}
