//
//  FaceLiveCollectionViewController.m
//  MyDouYu
//
...
@interface FaceLiveCollectionViewController ()

@end

@implementation FaceLiveCollectionViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.cellType = LiveCellTypeFaceLevel;
...
- (void)refreshData{
    self.offset = 0;
    __block NSString *url = [NSString stringWithFormat:@"http://capi.douyucdn.cn/api/v1/getColumnRoom/8?aid=ios&client_sys=ios&limit=20&offset=%d&time=1469015520&auth=19d9ee69d294976b98b90b67a2ca9f94",self.offset] ;
    self.lastUrl = url;
