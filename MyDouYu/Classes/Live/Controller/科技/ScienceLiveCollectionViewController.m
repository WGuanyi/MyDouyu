//
//  ScienceLiveCollectionViewController.m
//  MyDouYu
//
...
@interface ScienceLiveCollectionViewController () <LiveTopViewDelegate>
...
@implementation ScienceLiveCollectionViewController
...
- (void)loadNewData {
    ...
    [[HTTPManager sharedInstance] GET:url parameters:nil
...
- (void)loadAllGameData {
    NSString *path = @"http://capi.douyucdn.cn/api/v1/getHotRoom/3?aid=ios&client_sys=ios&time=1468825800&auth=94d0ae945c16542cc6dee7fe031f1316";
...
- (void)liveTopView:(LiveTopView *)topView didClickButtonTitle:(NSString *)title {
    NSString *url = [NSString stringWithFormat:@"http://capi.douyucdn.cn/api/v1/getColumnRoom/3?aid=ios&client_sys=ios&limit=20&offset=%d&time=1469008980&auth=3392837008aa8938f7dce0d8c72c321d",self.offset];
    self.url = url;
    [self.collectionView.mj_header beginRefreshing];
}
