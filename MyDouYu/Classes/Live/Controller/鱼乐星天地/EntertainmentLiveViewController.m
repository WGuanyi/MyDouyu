//
//  EntertainmentLiveViewController.m
//  MyDouYu
//
...
@interface EntertainmentLiveViewController () <LiveTopViewDelegate>
...
@implementation EntertainmentLiveViewController
...
- (void)loadAllGameData {
    NSString *path = @"http://capi.douyucdn.cn/api/v1/getHotRoom/2?aid=ios&client_sys=ios&time=1468825800&auth=94d0ae945c16542cc6dee7fe031f1316";
...
- (void)liveTopView:(LiveTopView *)topView didClickButtonTitle:(NSString *)title {
    NSString *url = [NSString stringWithFormat:@"http://capi.douyucdn.cn/api/v1/getColumnRoom/2?aid=ios&client_sys=ios&limit=20&offset=%d&time=1469009220&auth=cfde7142646e9d6305ae3a37e0e3c176",self.offset];
    self.url = url;
    [self.collectionView.mj_header beginRefreshing];
}
